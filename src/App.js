...
const [showListModal, setShowListModal] = useState(false);
  ...
  const letters = [
    ...
    {id: 6, title: "Ngày 25/02/2025", content: "Nói sao nhỉ, chẳng biết tại sao em bé lại ghét việc trả lời tin nhắn anh như thế nữa, đi học về nhắn cho em rằng anh về an toàn rùi nè, mưa to nữa ướt hết, nhắn vậy chỉ mong nhận lại tin nhắn phản hồi của em thui, nhưng em có trả lời anh đâu, cũng chẳng phải em bận, tin nhắn vẫn thông báo đều em vẫn đang nhắn với bạn mà, sao không trả lời anh được một câu ngay vậy, nhìn em nhắn tin với bạn nhưng tin nhắn anh gửi em còn không trả lời cũng buồn, cũng tủi thân lắm"}
  ];
